                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="inputState" class="form-control" name="filial">
                                    ...
                                    <option value="10" <c:if test="${produto.getFilial().getId() == 10}">selected</c:if>>Rio de Janeiro</option>
                                    <option value="11" <c:if test="${produto.getFilial().getId() == 11}">selected</c:if>>Minas Gerais</option>
                                    <option value="12" <c:if test="${produto.getFilial().getId() == 12}">selected</c:if>>Curitiba</option>
                                </select>
                            </div>
