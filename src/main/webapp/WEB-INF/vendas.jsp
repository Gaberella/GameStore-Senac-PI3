<%-- 
    Document   : vendas.jsp
    Created on : 16 de nov de 2021, 22:15:03
    Author     : macba
--%>
                ...
                <table class="table" id="tabelaservicos">
                    ...
                    <tbody>
                        <c:forEach items="${vendas}" var="v">
                            <tr>
                                <td scope="row"><c:out value="${v.idcliente}" /></td>
                                <td><c:out value="${v.idfuncionario}" /></td>
                                <td><c:out value="${v.idfilial}" /></td>
                                <td><c:out value="${v.data}" /></td>
                                <td><c:out value="${v.precoVenda}" /></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
